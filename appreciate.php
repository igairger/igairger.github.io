...
<!-- ---------------------- JUDUL TABEL ---------------------- -->
    <h3><i class="far fa-envelope mt-2"></i> Appreciate </h3><hr>
  ...
  <table class="table table-striped table-bordered table-font mt-2">
    ...
    <?php include 'db_Connection.php'; ?>
      <?php 
        if(isset($_GET['cari'])){
          $cari = $_GET['cari'];
          $query = ("SELECT * FROM appreciate WHERE kepada like '%".$cari."%'");  
          global $connect;
          $query_data=mysqli_query($connect, $query);
        } else{
          $query=("SELECT * FROM appreciate ORDER BY id_appreciate ASC");
          global $connect;
          $query_data=mysqli_query($connect, $query);
        }
      ...
      <tr>
        <td align="center"><?php echo $row['id_appreciate'];?></td>
        <td align="center"><?php echo $row['id_appreciate'];?></td>
